...
def load_trajectory():
    with open(f"../discrete_space/CHI/chi_trajectory.pkl", "rb") as f:
...
def tracs_vs_strawman_gps_tky(traj, epsilon):
    ...
    return averaged_l2_distance(gps_traj, gps_perturbed_traj_strawman[1:]), averaged_l2_distance(gps_traj, gps_perturbed_traj_tracs_d), averaged_l2_distance(gps_traj, gps_perturbed_traj_tracs_c)
...
if __name__ == '__main__':
    for epsilon in [2, 4, 6, 8, 10]:
        ...
        print(f"epsilon: {epsilon}, tracs-d: {distance_tracs_d / 2000}, strawman: {distance_strawman / 2000}, tracs-c: {distance_tracs_c / 2000}")
        # save to csv
        with open(f"./results/experiment_5_chi.csv", "a") as f:
            # header
            if epsilon == 2:
                # # clear the file
                # f.seek(0)
            ...
            f.write(f"{epsilon},{distance_tracs_d / 2000},{distance_strawman / 2000},{distance_tracs_c / 2000}\n")
