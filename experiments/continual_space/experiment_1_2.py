...
def tracs_d_vs_strawman(epsilon, num_locations):
    ...
    for i in range(num_locations):
        ...
        # strawman
        perturbed_trajectory_strawman[i] = strawman_perturbation(ref_location, location, epsilon, x_max, y_max)
        # tracs-c
        epsilon_1 = epsilon / 2
        tracs_c = CoordinatePerturbation(location, epsilon, epsilon_1, x_max, y_max)
        tracs_c.perturb()
