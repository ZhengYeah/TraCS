...
if __name__ == '__main__':
    ...
    row = [f"epsilon: 2", np.mean(error_list[:, 0]), np.mean(error_list[:, 1]), np.mean(error_list[:, 2]), np.mean(error_list[:, 3]), np.mean(error_list[:, 4])]
    ...
    error_list = np.array(error_list)
    row = [f"epsilon: 4", np.mean(error_list[:, 0]), np.mean(error_list[:, 1]), np.mean(error_list[:, 2]), np.mean(error_list[:, 3]), np.mean(error_list[:, 4])]
    ...
    error_list = np.array(error_list)
    row = [f"epsilon: 6", np.mean(error_list[:, 0]), np.mean(error_list[:, 1]), np.mean(error_list[:, 2]), np.mean(error_list[:, 3]), np.mean(error_list[:, 4])]
    ...
    error_list = np.array(error_list)
    row = [f"epsilon: 8", np.mean(error_list[:, 0]), np.mean(error_list[:, 1]), np.mean(error_list[:, 2]), np.mean(error_list[:, 3]), np.mean(error_list[:, 4])]
    ...
    error_list = np.array(error_list)
    row = [f"epsilon: 10", np.mean(error_list[:, 0]), np.mean(error_list[:, 1]), np.mean(error_list[:, 2]), np.mean(error_list[:, 3]), np.mean(error_list[:, 4])]
