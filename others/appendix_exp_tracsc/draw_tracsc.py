...
epsilon = 4
location_space = discrete_location_grid(3, x_max=1, y_max=1)
input_x = (0, 0)
perturbed_loc_0 = PiecewiseMechanism(input_x[0], epsilon).linear_perturbation()
perturbed_loc_1 = PiecewiseMechanism(input_x[1], epsilon).linear_perturbation()
